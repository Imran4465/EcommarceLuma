...
Description: "Online user can register luma ecommerce website to purchase, return, deliver, exchange, clearance, sale, etc."   

@sanity
Scenario Outline: User can login to the website with valid credentials and purchase the specific men's jacket.
